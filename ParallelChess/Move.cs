...
namespace ParallelChess {
    ...
    public enum Move {
        ...
        // a = castling
        // l = pawn move (used for half move clock)
    ...
    //    //public bool pawnMove; // pawn move is not needed we can figure this out in 

    //    // for undo
    //    public byte previousEnpassant;
    //    public CastlingBits previousCastlingBits;
    //    public int previousHalfMove;
    //}


    //public static class MoveHelper {
    //    public static Move CreateMove(int targetPosition, int fromPosition, Piece capturedPiece, Piece promotion, MoveFlags bits, byte castlingBits) {
    //        return new Move() {
