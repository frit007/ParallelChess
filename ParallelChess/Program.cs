...
namespace ParallelChess {
    class Program {
        static void Main() {
            //var boardw = Board.LoadBoardFromFen();
            ...
            //BoardState board = Board.LoadBoardFromFen("4k3/8/8/8/7q/3N4/8/3QK3 w - - 0 1");
            Board board = Board.LoadBoardFromFen(Console.ReadLine());
