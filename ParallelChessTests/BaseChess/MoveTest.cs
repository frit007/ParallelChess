...
namespace ParallelChessTests.BaseChess {
    class MoveTest {
        ...
        Move DoubleMove() => MoveHelper.CreateMove(toPosition, fromPosition, Piece.EMPTY, Piece.EMPTY, MoveFlags.ENPASSANT, new Board(new byte[BoardStateOffset.BOARD_STATE_SIZE]) );
