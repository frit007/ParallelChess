    ...
    class EndGameTest {
        ...
        public void CheckMateWhite() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("rnbqkbnr/1ppppQp1/8/8/2BPP3/p6p/PPP2PPP/RNB1K1NR b KQkq - 0 1");
        ...
        public void QueenCheckMateWhite() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("1k2Q3/pppp1ppp/8/8/8/8/8/2K5 b - - 0 1");
        ...
        public void CheckMateBlack() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/2ppp3/8/8/8/8/2PPP3/3K1q2 w - - 0 1");
        ...
        public void Stalemate() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/2ppp3/8/8/8/2r1r3/5r2/3K4 w - - 0 1");
        ...
        public void InsufficientMaterial2Kings() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/8/8/8/8/8/3K4 w - - 0 1");
        ...
        public void InsufficientMaterial1Bishop() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/8/8/8/5B2/8/3K4 w - - 0 1");
        ...
        public void InsufficientMaterial1Knight() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/8/8/8/5N2/8/3K4 w - - 0 1");
        ...
        public void SufficientMaterial2Knights() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/8/8/8/4NN2/8/3K4 w - - 0 1");
        ...
        public void SufficientMaterial1KnightAnd1Bishop() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/8/8/8/4NB2/8/3K4 w - - 0 1");
        ...
        public void SufficientMaterial1Pawn() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/8/8/8/8/4P3/3K4 w - - 0 1");
        ...
        public void InsufficientMaterial2BishopSameColor() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/4b3/8/4B3/8/8/3K4 w - - 0 1");
        ...
        public void SufficientMaterial2BishopDifferentColor() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/8/5b2/8/4B3/8/8/3K4 w - - 0 1");
        ...
        public void FiftyStaleMoves() {
            ...
            +---------------+
             A B C D E F G H
             */
            var board = BoardFactory.LoadBoardFromFen("3k4/2ppp1R1/8/8/8/8/7r/3K4 w - - 48 2");
