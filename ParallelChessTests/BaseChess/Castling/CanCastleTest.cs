        ...
        public void WhiteCastleQueenSide() {
             ...
             * Start position (White to play)
             ...
             +---------------+
              A B C D E F G H
             */
            Board board = Board.LoadBoardFromFen("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1");
        ...
        public void BlackCastleKingSide() {
             ...
             * Start position (Black to play)
             ...
             +---------------+
              A B C D E F G H
             */
            Board board = Board.LoadBoardFromFen("r3k2r/8/8/8/8/8/8/R3K2R b KQkq - 0 1");
        ...
        public void BlackCannotCastleQueenSideIfBitIsNotSet() {
             ...
             * Start position (Black to play)
             ...
             +---------------+
              A B C D E F G H
             */
            Board board = Board.LoadBoardFromFen("r3k2r/8/8/8/8/8/8/R3K2R b - - 0 1");
